...
public class SteeringBehaviours : MonoBehaviour {
	...
	public float MaxSpeed=100f, Mass=1f, overlapRadius = 1; // Speed limiter, objects weight and our overlap radius
...
//			taggedCount = FindBoids (5);//Parameter is the Radius for locating boids
//		}
		if (OffsetPursuitBool) {
	...
	Vector3 PathFollow()
	{
		...
		{
			return Arrive (path.NextPoint());
		}
		else
		{
			return Seek (path.NextPoint());
		}
	}
